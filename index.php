...
<head>
    ...
    <title>CRUD EN PHP GEOVANY ALONSO</title>
</head>
<body>
<div class="container">
    <div class="formText mt-5  w-100">
        <form method="post" action="<?php echo $Page; ?>">
            ...
            <div class="button text-right <?php echo $showClass; ?>" >
                <button id="btnInsert" class="btn btn-primary btnInsert  " name="btnInsert"><i class="fa fa-plus" ></i> Registrar</button>
            </div>
        </form>
                ...
                <?php
                        ...
                        <tr>
                            ...
                            <td> <button type="submit" name="btnEdit" id="btnEdit" value="<?= $row['user_id']; ?>" 
                             class="btn btn-warning"><i class="fa fa-edit"></i> Modificar</button> </td>
